  ...
  <q-page class="q-pa-sm">
    ...
    >
      ...
      <template v-slot:body-cell-status="props">
        <q-td :props="props">
          <q-chip :color="(props.row.status == 'Active')?'green':(props.row.status == 'Inactive'?'red':'grey')"
    ...
    export default {
        data() {
            return {
                ...
                mode: 'list',
                columns: [
                    {name: 'invoice_id', align: 'left', label: '#', field: 'invoice_id', sortable: true},
                    {
                        name: 'account',
                        required: true,
                        label: 'Account',
                    ...
                    {name: 'invoice_date', align: 'left', label: 'Invoice Date', field: 'invoice_date', sortable: true},
                    {
                        name: 'due_date',
                        align: 'left',
                        label: 'Due Date',
                    ...
                    {name: 'invoice_type', align: 'left', label: 'Invoice Type', field: 'invoice_type', sortable: true},
